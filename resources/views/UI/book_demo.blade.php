...
<li><a href="contact.html"><div>Sign Up</div></a></li>-->
		...
		<section id="page-title">
			...
			<div class="container clearfix">
				<h1 class="center">Book A Demo</h1>
							...
							<div class="col-lg-8 p-5">
								...
								<form class="row mb-0" id="partner-form" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    {{-- <div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-name">Select Course</label>
											</div>
											<div class="col-sm-9">
												<select name="" class="form-control" id="classes">
                                                    <option value="" selected disabled>Select Classes</option>
                                                    <option value="Harmonium">Harmonium</option>
                                                    <option value="Guitar">Guitar</option>
                                                    <option value="Violin">Violin</option>
                                                    <option value="Guitar">Guitar</option>
                                                    <option value="Maths Tuitions">Maths Tuitions</option>
                                                    <option value="Science Tuitions">Science Tuitions</option>
                                                    <option value="Maths Tuitions">Maths Tuitions</option>
									...
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-name">Course Name</label>
											</div>
											<div class="col-sm-9">
												<input type="hidden" name="partner-form-name" id="teacher_id" class="form-control" required value="<?php echo $_GET['id']; ?>" placeholder="Enter your First Name" disabled>

												<input type="text" name="partner-form-name" id="classes" class="form-control" required value="<?php echo $_GET['course_name']; ?>" placeholder="Enter your First Name" disabled>
											</div>
										</div>
									</div>
									...
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-name">Tutor Name</label>
											</div>
											<div class="col-sm-9">
												<input type="text" name="partner-form-name" id="" class="form-control" required value="<?php echo $_GET['tutor_name']; ?>" placeholder="Enter your First Name" disabled>
											</div>
										</div>
									</div>
									...
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-name">First Name</label>
											</div>
											<div class="col-sm-9">
												<input type="text" name="partner-form-name" id="first_name" class="form-control" required value="" placeholder="Enter your First Name">
											</div>
										</div>
									</div>
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-email">Last Name</label>
											</div>
											<div class="col-sm-9">
												<input type="text" name="partner-form-email" id="last_name" class="form-control" required value="" placeholder="Enter Last Name">
											</div>
										</div>
									</div>
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-phone">Email Id</label>
											</div>
											<div class="col-sm-9">
												<input type="text" name="partner-form-phone" id="email" class="form-control" required value="" placeholder="Your Email Id">
											</div>
										</div>
									</div>
                                  ...
                                  <div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-state">Contact Number</label>
											</div>
											<div class="col-sm-9">
												<input type="text" name="partner-form-state" id="contact" class="form-control" required value="" placeholder="Your Contact Number">
											</div>
										</div>
									</div>
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-city">Country</label>
											</div>
											<div class="col-sm-9">
												<input type="text" name="partner-form-city" id="country" class="form-control" required value="" placeholder="Your Country">
											</div>
										</div>
									</div>
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-class">State</label>
											</div>
											<div class="col-sm-9">
												<input type="text" name="partner-form-class" id="state" class="form-control" required value="" placeholder="Your State">
											</div>
										</div>
									</div>
									<div class="col-12 form-group">
										<div class="row">
											<div class="col-sm-3 col-form-label">
												<label for="partner-form-subject">City</label>
											</div>
											<div class="col-sm-9">
												<input type="text" name="partner-form-subject" id="city" class="form-control" required value="" placeholder="Your City">
											</div>
										</div>
									</div>
									...
									<div class="col-12 d-flex justify-content-end align-items-center">
										...
										<input type="button" id="BookClass" name="send" class="btn btn-success ml-2"  value="Submit Details">
									</div>
